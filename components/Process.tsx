...
import { Search, PenTool, Code2, ArrowLeft } from 'lucide-react';

const steps = [
  {
    id: 1,
    title: "تحلیل و نیازسنجی",
    desc: "بررسی دقیق نیازمندی‌های کسب‌وکار شما برای ارائه بهترین راهکار.",
    icon: <Search className="w-6 h-6" />,
  },
  {
    id: 2,
    title: "طراحی رابط کاربری",
    desc: "خلق تجربه‌ای بصری، مدرن و کاربرپسند مطابق با هویت بصری برند.",
    icon: <PenTool className="w-6 h-6" />,
  },
  {
    id: 3,
    title: "توسعه و پیاده‌سازی",
    desc: "کدنویسی تمیز و استاندارد با استفاده از تکنولوژی‌های روز دنیا.",
      ...
      <div className="container mx-auto">
        <div className="flex flex-col lg:flex-row items-center gap-16">
          ...
          <div className="lg:w-1/3 text-right">
            <h2 className="text-primary font-bold text-lg mb-2">مراحل کار</h2>
            <h3 className="text-3xl font-bold text-text mb-6">مسیر موفقیت پروژه شما</h3>
            <p className="text-gray-600 mb-8 leading-loose">
              ما در ایده‌پرداز مهر با یک متدولوژی چابک و شفاف، ایده شما را به محصولی کارآمد تبدیل می‌کنیم. هر مرحله با دقت و مشارکت شما پیش می‌رود.
            </p>
            <a href="#contact" className="inline-flex items-center text-primary font-bold hover:gap-4 gap-2 transition-all">
              شروع همکاری
